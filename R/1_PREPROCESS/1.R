...
mat.list.pair =  Motif_cmb.combined_sel
save(mat.list.pair, file="../DATA/PAIR/mat.list.pair.rda")

mat.list.source = source_Motif_cmb.combined_sel
save(mat.list.source, file="../DATA/SOURCE/mat.list.source.rda")

mat.list.target = target_Motif_cmb.combined_sel
save(mat.list.target, file="../DATA/TARGET/mat.list.target.rda")
